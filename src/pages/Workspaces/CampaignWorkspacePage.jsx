...
//   // "template-single": [FK.CAMPAIGN_CREATE],
//   "status-logs": [FK.CAMPAIGN_VIEW],
//   // "cta-management": [FK.CAMPAIGN_CREATE],
//   // "image-campaign-new": [FK.CAMPAIGN_CREATE],
...
//   "send-template-msg": [FK.CAMPAIGN_CREATE], // ?? "messaging.send.template",
//   "campaign-builder": [FK.CAMPAIGN_CREATE],
//   // CampaignWizard: [FK.CAMPAIGN_CREATE],
...
//   {
//     id: "image-campaign-list",
//     label: "Image bases Campaigns",
//     description: "View past image campaigns or send them again.",
//     path: "/app/campaigns/ImageCampaignListPage",
//     icon: <Image className="text-purple-500" size={22} />,
//     action: "View & Send",
//   },
//   {
//     id: "template-campaign-list",
//     label: "Template based Campaigns",
//     description: "View and manage Meta template-based campaigns.",
//     path: "/app/campaigns/template-campaigns-list",
//     icon: <PlusCircle className="text-green-600" size={22} />,
//     action: "View & Send",
...
//   {
//     id: "campaign-builder",
//     label: "Campaign Builder (Using Flow)",
//     description: "Create campaign using Meta templates.",
//     path: "/app/campaigns/template-campaign-builder",
//     icon: <PlusCircle className="text-green-600" size={22} />,
//     action: "Create Campaign-Template",
//     featureKey: "Campaigns",
...
//                       }}
//                       onClick={() => navigate(block.path)}
//                       className="bg-white rounded-md border shadow-sm hover:shadow-md transition transform hover:-translate-y-0.5 duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-300"
//                     >
//                       <div className="flex items-start gap-4 p-5">
//                         <div className="bg-gray-100 rounded-md p-2">
//                           {block.icon}
...
//                         <button
//                           onClick={e => {
//                             e.stopPropagation(); // keep the button working without double nav
//                             navigate(block.path);
//                           }}
//                           className="text-sm text-purple-600 font-medium flex items-center gap-1 hover:text-purple-800"
//                         >
...
//   );
// }
// 📄 File: src/pages/Campaigns/CampaignWorkspacePage.jsx
